...
\texttt{Router} & (TODO) LLM-based rozhodovanie medzi Data Tools a~Database queries \\
\bottomrule
\end{tabular}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth,height=0.62\textheight,keepaspectratio]{frontend/ukazka_chat_komponentu.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,height=0.68\textheight,keepaspectratio]{frontend/ukazka_sidebar.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.55\textheight,keepaspectratio]{frontend/ukazka_database_modal.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.35\textheight,keepaspectratio]{frontend/ukazka_chatheader.png}
